...
class TenantTickets extends StatefulWidget {
  const TenantTickets({Key? key}) : super(key: key);

  @override
  State<TenantTickets> createState() => _TenantTicketsState();
}

class _TenantTicketsState extends State<TenantTickets> {
  @override
